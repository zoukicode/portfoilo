...
export function Projets({ text, langue, setLangue }) {
  ...
  target="_blank"
>
  <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="#263b7a" width="45" height="45">
